...
def load_basic_ssen_image(
    ...
    for stg_cand in (stage, f"자신감 {stage}" if not stage.startswith("자신감") else stage):
...
BASIC_SSEN_STAGE_ANSWER_MAP: dict[tuple[str, str], int] = {
    ("01 삼각형의 성질 (1)", "기본&핵심유형 1 (11~15쪽)"): 1,
    ("01 삼각형의 성질 (1)", "기본&핵심유형 2 (19~21쪽)"): 1,
    ("01 삼각형의 성질 (1)", "꼭 나오는 학교시험기출 (22~23쪽)"): 1,

    ("02 삼각형의 성질 (2)", "기본&핵심유형 1 (29~31쪽)"): 1,
    ("02 삼각형의 성질 (2)", "기본&핵심유형 2 (36~40쪽)"): 1,
    ("02 삼각형의 성질 (2)", "꼭 나오는 학교시험기출 (41~42쪽)"): 1,

    ("03 사각형의 성질 (1)", "기본&핵심유형 1 (47~50쪽)"): 2,
    ("03 사각형의 성질 (1)", "기본&핵심유형 2 (54~57쪽)"): 2,
    ("03 사각형의 성질 (1)", "꼭 나오는 학교시험기출 (58~59쪽)"): 2,

    ("04 사각형의 성질 (2)", "기본&핵심유형 1 (66~68쪽)"): 2,
    ("04 사각형의 성질 (2)", "기본&핵심유형 2 (72~74쪽)"): 2,
    ("04 사각형의 성질 (2)", "기본&핵심유형 3 (77~81쪽)"): 2,
    ("04 사각형의 성질 (2)", "꼭 나오는 학교시험기출 (82~84쪽)"): 2,

    ("05 도형의 닮음", "기본&핵심유형 1 (91~94쪽)"): 3,
    ("05 도형의 닮음", "기본&핵심유형 2 (98~101쪽)"): 3,
    ("05 도형의 닮음", "꼭 나오는 학교시험기출 (102~104쪽)"): 3,

    ("06 평행선 사이의 선분의 길이의 비", "기본&핵심유형 1 (109~111쪽)"): 3,
    ("06 평행선 사이의 선분의 길이의 비", "기본&핵심유형 2 (114~115쪽)"): 3,
    ("06 평행선 사이의 선분의 길이의 비", "꼭 나오는 학교시험기출 (116~117쪽)"): 3,

    ("07 삼각형의 무게중심과 닮음의 활용", "기본&핵심유형 1 (121~124쪽)"): 3,
    ("07 삼각형의 무게중심과 닮음의 활용", "기본&핵심유형 2 (128~130쪽)"): 3,
    ("07 삼각형의 무게중심과 닮음의 활용", "기본&핵심유형 3 (133~135쪽)"): 4,
    ("07 삼각형의 무게중심과 닮음의 활용", "꼭 나오는 학교시험기출 (136~138쪽)"): 4,

    ("08 피타고라스 정리", "기본&핵심유형 1 (144~147쪽)"): 4,
    ("08 피타고라스 정리", "기본&핵심유형 2 (150~151쪽)"): 4,
    ("08 피타고라스 정리", "기본&핵심유형 3 (155~156쪽)"): 4,
    ("08 피타고라스 정리", "꼭 나오는 학교시험기출 (157~158쪽)"): 4,

    ("09 경우의 수", "기본&핵심유형 1 (165~170쪽)"): 4,
    ("09 경우의 수", "기본&핵심유형 2 (175~178쪽)"): 5,
    ("09 경우의 수", "꼭 나오는 학교시험기출 (179~180쪽)"): 5,

    ("10 확률", "기본&핵심유형 1 (187~189쪽)"): 5,
    ("10 확률", "기본&핵심유형 2 (193~195쪽)"): 5,
    ("10 확률", "꼭 나오는 학교시험기출 (196~197쪽)"): 5,
}


def get_basic_ssen_answer_page(subunit: str, stage: str) -> int:
    clean_stage = stage.replace("자신감 ", "").strip()
    for (sub, stg), page_num in BASIC_SSEN_STAGE_ANSWER_MAP.items():
        clean_stg = stg.replace("자신감 ", "").strip()
        if (sub in subunit or subunit in sub) and (clean_stg in clean_stage or clean_stage in clean_stg):
            return page_num
